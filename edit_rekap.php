...
$sql = "SELECT `rekap`.`rekap_id`, `siswa`.`siswa_foto`, `siswa`.`siswa_nama`, `rekap`.`rekap_tanggal`, `rekap`.`rekap_masuk`, `rekap`.`rekap_keluar`, `rekap`.`rekap_photomasuk`, `rekap`.`rekap_photokeluar`, `rekap`.`rekap_keterangan` 
        FROM `rekap` INNER JOIN `siswa` ON `rekap`.`siswa_id` = `siswa`.`siswa_id` WHERE `rekap`.`rekap_id` = '$id'";
$result = $koneksi->query($sql);
    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="./data_kelas.php">Data Rekap</a></li>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control" id="kelasNama" name="kelasNama"
                                    placeholder="Masukkan Nama Kelas" value="<?php echo $siswa_nama; ?>"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="custom-select" id="rekapStatus" name="rekapStatus" autocomplete="off"
                                    ...
                                    <option value="Alpa"
                                        <?php echo ($rekap_keterangan == 'Alpa') ? "selected" : "" ?>>
                                        Alpa</option>
                                </select>
                            </div>
                        </div>
